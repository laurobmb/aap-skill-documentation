...
> Total: **~29 guias oficiais Red Hat** destilados em ~700 páginas de conteúdo estruturado.
...
Usando aap-26-mesh-performance, como configurar um hop node para DMZ com acesso outbound-only?

Usando aap-26-integracoes, como configurar o HashiCorp Vault como External Secret Provider?

Usando aap-26-controller-uso, como criar um workflow com aprovação humana antes do deploy em produção?
...
Os seguintes guias ainda não foram processados e podem compor novas skills:

| Guia | Possível skill |
|---|---|
| Using automation dashboard | `aap-26-dashboard` |
| Using content navigator (`ansible-navigator`) | `aap-26-dev-tools` |
| Red Hat Lightspeed (AI para código Ansible) | `aap-26-dev-tools` |
| Self-service portal (creation, customization, usage) | `aap-26-self-service` |
| Developer Hub integrations | `aap-26-developer-hub` |
